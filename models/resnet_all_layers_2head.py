...
def ResNet18_2head():
    return ResNet_2head(BasicBlock, [2, 2, 2, 2])


def ResNet34_2head():
    return ResNet_2head(BasicBlock, [3, 4, 6, 3])


def ResNet50_2head():
    return ResNet_2head(Bottleneck, [3, 4, 6, 3])


def ResNet101_2head():
    return ResNet_2head(Bottleneck, [3, 4, 23, 3])


def ResNet152_2head():
    return ResNet_2head(Bottleneck, [3, 8, 36, 3])
