...
class ResNet_4head_comple(nn.Module):
    def __init__(self, block, num_blocks, num_classes=10):
        super(ResNet_4head_comple, self).__init__()
        self.in_planes = 64
        ...
        self.linear_3 = nn.Linear(512*block.expansion, num_classes)
        self.linear_4 = nn.Linear(512*block.expansion, 3)
    ...
    def forward(self, x, branch=0):
        ...
        out = F.avg_pool2d(out17, 4)
        out = out.view(out.size(0), -1)
        out18_2 = self.linear_4(out)
            
            
        return [out18, out18_2]
   
    def forward_classify(self, x, branch=0):
        out1 = F.relu(self.bn1(self.conv1(x)))
    ...
    def forward_all(self, x):
        ...
        out = F.avg_pool2d(out17, 4)
        out = out.view(out.size(0), -1)
        out18_4 = self.linear_4(out)
        
        return [out18, out18_2, out18_3, out18_4] #
    
    def forward_three_seq(self, x, bs1, bs2, bs3):
        out1 = F.relu(self.bn1(self.conv1(x)))
        ...
        out16 = F.relu(self.bn_lay8_1(self.conv_lay8_1(out15[:bs1])))
        out = self.bn_lay8_2(self.conv_lay8_2(out16))
        out += self.shortcut_lay8(out15[:bs1])
        out17 = F.relu(out)
        ...
        out16 = F.relu(self.bn_lay8_1_2(self.conv_lay8_1_2(out15[bs1:bs1+bs2])))
        out = self.bn_lay8_2_2(self.conv_lay8_2_2(out16))
        out += self.shortcut_lay8_2(out15[bs1:bs1+bs2])
        out17 = F.relu(out)
        ...
        out16 = F.relu(self.bn_lay8_1_3(self.conv_lay8_1_3(out15[bs1+bs2:])))
        out = self.bn_lay8_2_3(self.conv_lay8_2_3(out16))
        out += self.shortcut_lay8_3(out15[bs1+bs2:])
        out17 = F.relu(out)
    ...
    def forward_two_seq(self, x, bs1):
        out1 = F.relu(self.bn1(self.conv1(x)))
        ...
        out16 = F.relu(self.bn_lay8_1_2(self.conv_lay8_1_2(out15[bs1:])))
        out = self.bn_lay8_2_2(self.conv_lay8_2_2(out16))
        out += self.shortcut_lay8_2(out15[bs1:])
        out17 = F.relu(out)
    ...
    def forward_three_h(self, x, h=0):
        out1 = F.relu(self.bn1(self.conv1(x)))
        ...
        out16 = F.relu(self.bn_lay8_1(self.conv_lay8_1(out15[:h//2])))
        out = self.bn_lay8_2(self.conv_lay8_2(out16))
        out += self.shortcut_lay8(out15[:h//2])
        out17 = F.relu(out)
        ...
        out16 = F.relu(self.bn_lay8_1_2(self.conv_lay8_1_2(out15[h//2:h])))
        out = self.bn_lay8_2_2(self.conv_lay8_2_2(out16))
        out += self.shortcut_lay8_2(out15[h//2:h])
        out17 = F.relu(out)
        ...
        out16 = F.relu(self.bn_lay8_1_3(self.conv_lay8_1_3(out15[h:])))
        out = self.bn_lay8_2_3(self.conv_lay8_2_3(out16))
        out += self.shortcut_lay8_3(out15[h:])
        out17 = F.relu(out)
        ...
        return torch.cat((out18, out18_2, out18_3))
    
    def forward_two_h(self, x, h=0):
        out1 = F.relu(self.bn1(self.conv1(x)))
...
def ResNet18_4head_comple():
    return ResNet_4head_comple(BasicBlock, [2, 2, 2, 2])


def ResNet34_4head_comple():
    return ResNet_4head_comple(BasicBlock, [3, 4, 6, 3])


def ResNet50_4head_comple():
    return ResNet_4head_comple(Bottleneck, [3, 4, 6, 3])


def ResNet101_4head_comple():
    return ResNet_4head_comple(Bottleneck, [3, 4, 23, 3])


def ResNet152_4head_comple():
    return ResNet_4head_comple(Bottleneck, [3, 8, 36, 3])
