...
def ResNet18_ori():
    return ResNet_ori(BasicBlock, [2, 2, 2, 2])


def ResNet34_ori():
    return ResNet_ori(BasicBlock, [3, 4, 6, 3])


def ResNet50_ori():
    return ResNet_ori(Bottleneck, [3, 4, 6, 3])


def ResNet101_ori():
    return ResNet_ori(Bottleneck, [3, 4, 23, 3])


def ResNet152_ori():
    return ResNet_ori(Bottleneck, [3, 8, 36, 3])
